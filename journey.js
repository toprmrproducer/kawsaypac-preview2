(() => {
  ...
  const all=[s1,s2,s3,s1title,s1peak,s1cloud,s1shoulder,s1sky,s2base,s2ridgeL,s2ridgeR,s2river,s2cotopaxi,s2c2,s2c3,s2c4,s3base,s3frame,s3philo,s3canopy,s3brome,brand,summitBeat,waterBeat,finalCopy];
